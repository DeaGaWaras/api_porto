...
router.get("/", (req, res) => {
  const projects = [
    ...
    },
    {
      ...
      imgUrl:
        "https://i.postimg.cc/SxPy9XpH/Cosmetics-e-commerce-mobile-app-design.jpg",
    ...
    },
    {
      ...
      imgUrl:
        "https://i.pinimg.com/1200x/29/df/fe/29dffeb24bcbb18e567a9e96fb089211.jpg",
      keterangan:
        "A RESTful API for an AI platform, built with Node.js and Express.",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      imgUrl:
        "https://i.pinimg.com/1200x/fd/22/27/fd22270b02ab43eaffc61b72e3dd4010.jpg",
